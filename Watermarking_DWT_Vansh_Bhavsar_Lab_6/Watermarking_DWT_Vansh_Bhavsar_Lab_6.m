...
img = imread('https://imgs.search.brave.com/eUt9huxzUVB-nq3XQzMSqGXdVSY5-wENGENFU1VE8-0/rs:fit:500:0:0:0/g:ce/aHR0cDovL2xlbm5h/Lm9yZy9sZW5fc3Rk/LmpwZw');
...
imshow(watermark, []);
hold on;
text(size(img,2)/2, size(img,1)/2, 'VANSH', 'FontSize', 50, 'Color', 'white', 'FontWeight', 'bold', 'HorizontalAlignment', 'center');
